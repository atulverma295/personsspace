...
<body>
	...
	<div style="float: left">
		<form:form method="POST" action="search">
			<input type="radio" name="searchCriteria" value="Id">by id<br>
			<input type="radio" name="searchCriteria" value="name">by name <br>
			<input type="radio" name="searchCriteria" value="contact">by contact <br>
